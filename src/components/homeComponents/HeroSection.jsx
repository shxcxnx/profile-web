...
export const Hero = () => {
    const [handleButtonCv, setHandleButtonCv] = useState('Download CV');

    const changeButtonCV = () => {
        setHandleButtonCv('Ready!');
    };
    return (
        <section className='w-11/12  m-auto'>
            <div className='w-full h-screen md:h-screen flex flex-col justify-center items-center '>
                ...
                <h2 className='font-bold text-lg md:text-xl'>RAUL FERNANDO CALLEROS HERNANDEZ</h2>
                ...
                <div className='flex gap-6 mt-6'>
                    ...
                    {/* w-36 h-11 p-2 rounded-lg font-bold text-blue-500 hover:text-blue-700 border-2 border-blue-500 hover:border-blue-700 md:w-44 md:h-14 */}
                    {/* <a href='#contact'>
                        <button className='w-36 h-11 p-2 bg-red-500 hover:bg-red-700 text-white rounded-lg font-bold md:w-44 md:h-14 '>Contact Me</button>
                    </a> */}
                </div>

                <div className='flex justify-end gap-4 mt-6'>
                    <a href='https://www.instagram.com/rcllrhz/' target={'_blank'} className='text-black transition hover:text-red-500'>
                    ...
                    <a href='https://github.com/errecode' target={'_blank'} className='text-black transition hover:text-red-500'>
                        <span className='sr-only'>GitHub</span>
                        <svg className='w-6 h-6' fill='currentColor' viewBox='0 0 24 24' aria-hidden='true'>
                            <path
                                fillRule='evenodd'
